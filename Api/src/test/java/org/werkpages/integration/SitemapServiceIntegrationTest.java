...
class SitemapServiceIntegrationTest {
    ...
    void generate_emptyDatabase_returnsXmlWithOnlyStaticPages() throws Exception {
        ...
        assertTrue(xml.contains("https://werkpages.com/"));
        assertTrue(xml.contains("https://werkpages.com/directory"));
        assertTrue(xml.contains("https://werkpages.com/add"));
        assertTrue(xml.contains("https://werkpages.com/about"));
        assertTrue(xml.contains("https://werkpages.com/what-is-werkpages"));
        assertTrue(xml.contains("https://werkpages.com/support"));
        assertTrue(xml.contains("https://werkpages.com/privacy"));
    ...
    void generate_homepageHasHighestPriority() throws Exception {
        ...
        assertTrue(xml.contains("<loc>https://werkpages.com/</loc>"));
        // Find the first <url> block and verify it has 1.0 priority
        int homepageIdx = xml.indexOf("<loc>https://werkpages.com/</loc>");
